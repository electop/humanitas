...
#### 2. **주요 합성 안료 개발 타임라인**  
| 안료명          | RGB 코드      | 개발 연도 | 개발자                     | 주요 활용 분야             | 예술사적 기여                                   | 특징                                                                 |  
|-----------------|--------------|-----------|----------------------------|---------------------------|-----------------------------------------------|---------------------------------------------------------------------|  
| **프러시안 블루** | `#003171`   | 1704      | 하인리히 디스바흐          | 회화, 도자기               | 로코코·낭만주의 화풍의 어두운 톤 강화           | 최초의 합성 안료. 철시안화물 반응으로 제작, 강렬한 청색.              |  
| **코발트 블루**  | `#0047AB`   | 1802      | 루이 자크 테나르            | 회화, 유리 제조            | 모네의 \<수련\> 연작에서 물의 반사 효과 구현   | 알루미나와 코발트 산화물의 고온 반응으로 생성. 인상파 화가들이 애용. |  
| **카드뮴 옐로우** | `#FFF600`   | 1820년대  | 프리드리히 슈트로마이어     | 회화, 플라스틱             | 고흐의 \<해바라기\> 생동감 강화                | 카드뮴과 황의 화합물로 생산. 선명한 노란색.                          |  
| **합성 울트라마린** | `#120A8F`   | 1828      | 장-바티스트 기메            | 회화, 세탁                  | 르누아르의 그림자 표현 혁신                   | 천연 청금석 대체품. 값싸고 균일한 청자색 제공.                      |  
| **머우브**       | `#E0B0FF`   | 1856      | 윌리엄 퍼킨                | 직물, 인쇄                 | 19세기 패션 산업의 상징적 색상으로 활용        | 최초의 합성 유기 염료. 석탄 타르에서 추출한 아니린으로 제작.        |  
